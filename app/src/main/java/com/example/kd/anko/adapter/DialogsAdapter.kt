 ...
 */
class DialogsAdapter(val list: List<String> = listOf<String>("Toast", "Long Toast", "Alerts", "Selectors", "Progress dialogs"),
                     val itemClick: (Int) -> Unit) : RecyclerView.Adapter<DialogsAdapter.ViewHolder>() {
